...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{webhooks.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{stacks.png}
	\caption{Screenshot of stacks}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{nodes.png}
	\caption{Screenshot of Nodes}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{volumes.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{networks.png}
