...
The test configuration can be viewed at \href{https://github.com/TripleParity/docks-ui/blob/master/karma.conf.js}{here}.
The tests are inside a variety of files, in particular any file with a keywod "spec" inside \href{https://github.com/TripleParity/docks-ui/tree/master/src/app}{here}.
The test history is on \href{https://travis-ci.org/TripleParity/docks-ui}{travis}.
...
The tests are \href{https://github.com/TripleParity/docks-api/tree/master/spec}{here}.
The test history is on \href{https://travis-ci.org/TripleParity/docks-api}{travis}.
